...
object ControlFunction
{
    ...
    def aStarPathfind(cells: String, startingPoint: XY, view: View, destination: XY, bot: Bot) = {
        ...
        parent.update(index, startingPoint)
                        ...
                        //{
                            ...
                            { 
                                if(pos == destination)
                                {
                                    ...
                                    //parent()
                                    path = tracePath(parent, pos, startingPoint, view, bot)
                                    foundDest = true
                                    break
                                }
    ...
    def tracePath(parent: ListBuffer[XY], last: XY, dest: XY, view: View, bot: Bot) = { 

      
        var Path = ListBuffer[XY]()
        var returnPath = ListBuffer[XY]()
        var pos = XY(last.x, last.y)
        var index = view.indexFromRelPos(pos)
        
        bot.log(parent.indexOf(dest).toString)
        
        /*while(parent(index) != dest)
        {
