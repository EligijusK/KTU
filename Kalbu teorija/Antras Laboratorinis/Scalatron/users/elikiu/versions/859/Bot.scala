                ...
                for(i <- 0 until cellCount) {
                  ...
                  if(cellRelPos.isNonZero) {
                    ...
                    case 'P' =>
                        ...
                        val stepDistance = view.relPosFromIndex(i)
                        if (stepDistance == 1) 500 cellWeight(i) += 100
                        else if (stepDistance == 2) cellWeight(i) += 300
                        else (150 - stepDistance * 10).max(10) cellWeight(i) += 500
